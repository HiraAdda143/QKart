      ...
      <Box display="flex" alignItems="center" justifyContent="center" gap="8px">
        {!isReadOnly ? (
          <>
            ...
            <span data-testid="item-qty">{value}</span>
            <IconButton
              name="add"
              aria-label="add"
              color="primary"
          ...
          <>
            <span data-testid="item-qty">Qty: {value}</span>
          </>
        )}
      </Box>
    </>
      ...
      <Box className="cart">
              ...
              >
                ...
                >
                  <ItemQuantity
                    ...
                    value={item.qty}
                    handleAdd={async () => {
                      await handleQuantity(item.productId, item.qty + 1, token);
                    }}
                    handleDelete={async () => {
                      await handleQuantity(item.productId, item.qty - 1, token);
                    }}
        ...
        {!isReadOnly ? (
          <>
            <Stack
              direction="row"
              sx={{ justifyContent: "flex-end", padding: "1rem" }}
            >
              <Box>
                <Button
                  color="primary"
